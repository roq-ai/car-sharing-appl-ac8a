  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience a new way of mobility with Car Sharing Application, transforming your travel into an effortless, economical, and eco-friendly journey."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a new way of mobility with Car Sharing Application, transforming your travel into an effortless, economical, and eco-friendly journey.`}
            </Text>
            <Box
